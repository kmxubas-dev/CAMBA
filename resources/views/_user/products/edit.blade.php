    ...
    <div class="relative flex flex-col justify-center overflow-hidden py-6">
        <div class="container mx-auto w-full max-w-screen-xl">
            ...
            <div class="mb-4 flex items-center justify-between text-base">
                <h3 class="text-2xl text-purple-800">Edit Artwork</h3>
                ...
                <div class="space-y-4 lg:w-1/2">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative h-72 w-full overflow-hidden rounded-xl shadow-lg sm:h-[300px]">
                            ...
                            <button type="button"
                                    class="mt-2 flex w-full items-center justify-center rounded-full bg-purple-600 px-4 py-2 text-white shadow-md hover:bg-purple-700"
                        ...
                        <div class="space-y-2">
                            ...
                            <button type="button" id="viewNewImageButton"
                                    class="mt-2 hidden w-full items-center justify-center rounded-full bg-purple-600 px-4 py-2 text-white shadow-md hover:bg-purple-700"
